...
(assert (= (ite (bvult ((_ extract 255 0) (ite (= arg3 (_ bv0 256)) (_ bv0 512) (bvurem (bvadd (concat (_ bv0 256) arg1) (concat (_ bv0 256) arg2))(concat (_ bv0 256) arg3)))) arg3) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (not (= arg3 (_ bv0 256))))
(assert (not (= (_ bv0 256) arg3)))
