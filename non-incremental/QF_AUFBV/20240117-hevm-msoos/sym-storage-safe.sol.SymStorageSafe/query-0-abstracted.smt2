...
;        (Var "arg1")
;      storage:
;        (AbstractStore (SymAddr "entrypoint") Just 0x0)
;    )
;    (SLoad
;      slot:
;        (Var "arg2")
...
(declare-const baseStore_symaddr_entrypoint_0x0 Storage)
...
(assert (not (= (select baseStore_symaddr_entrypoint_0x0 arg1) (select baseStore_symaddr_entrypoint_0x0 arg2))))
(assert (= arg1 arg2))
