...
(assert (not (= (_ bv4 256) arg1)))
(assert (= (ite (bvult (_ bv4 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (= (ite (bvult (_ bv3 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (= (ite (bvult (_ bv2 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (= (ite (bvult (_ bv1 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (= (ite (bvult (_ bv0 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (bvult arg1 (_ bv5 256)))
(assert (= (ite (= (ite (bvult (_ bv3 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (= (ite (bvult (_ bv1 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
