...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and true (= (ite (= (ite (bvult (_ bv3 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))) true) true) (= (ite (= (ite (bvult (_ bv2 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))) true) true) (= (ite (= (ite (bvult (_ bv1 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))) true) true) (= (ite (= (ite (bvult (_ bv0 256) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))) (bvult arg1 (_ bv5 256))) true) true) true) true) (and true (bvult txdata_length (_ bv18446744073709551616 256)))) true))
