...
(assert (not (= (bvmul arg2 arg1) (bvmul arg1 arg2))))
...
(assert (not (= (bvor (ite (= arg1 (ite (= arg2 (_ bv0 256)) (_ bv0 256) (bvudiv (bvmul arg1 arg2) arg2))) (_ bv1 256) (_ bv0 256)) (ite (= arg2 (_ bv0 256)) (_ bv1 256) (_ bv0 256))) (_ bv0 256))))
(assert (not (= (bvmul arg2 arg1) (bvmul arg1 arg2))))
