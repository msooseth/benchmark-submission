...
(assert (= (ite (bvslt (bvsub arg2 arg1) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (bvor (bvand (ite (bvslt arg1 (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (ite (bvslt (bvsub arg2 arg1) arg2) (_ bv1 256) (_ bv0 256))) (bvand (ite (bvslt arg2 (bvsub arg2 arg1)) (_ bv1 256) (_ bv0 256)) (ite (= (ite (bvslt arg1 (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)))) (_ bv0 256)))
(assert (not (= (ite (bvslt arg2 arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256))))
