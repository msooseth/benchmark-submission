...
(assert (not (= (ite (bvslt (ite (= arg2 (_ bv0 256)) (_ bv0 256) (bvsrem arg1 arg2)) (bvsub (_ bv0 256) arg2)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))))
(assert (= (ite (bvslt (ite (= arg2 (_ bv0 256)) (_ bv0 256) (bvsrem arg1 arg2)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
