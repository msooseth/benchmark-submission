...
(assert (not (= (ite (bvslt (bvsub (_ bv0 256) (ite (= arg2 (_ bv0 256)) (_ bv0 256) (bvsrem arg1 arg2))) arg2) (_ bv1 256) (_ bv0 256)) (_ bv0 256))))
...
(assert (= (ite (bvslt arg2 (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
