...
(assert (not (= (bvsub (_ bv0 256) arg1) (bvsub (_ bv0 256) arg2))))
(assert (not (= (bvadd (_ bv57896044618658097711785492504343953926634992332820282019728792003956564819968 256) arg1) (_ bv0 256))))
(assert (= (ite (= (ite (bvslt arg1 (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
...
(assert (= (ite (= arg2 (_ bv0 256)) (_ bv0 256) (bvsrem arg1 arg2)) (ite (= arg1 (_ bv0 256)) (_ bv0 256) (bvsrem arg2 arg1))))
(assert (bvult (_ bv0 256) arg1))
(assert (= (ite (= arg2 (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
