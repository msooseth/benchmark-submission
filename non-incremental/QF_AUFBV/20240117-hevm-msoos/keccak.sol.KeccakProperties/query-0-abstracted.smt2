...
(define-fun buf0() Buf (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000)))

(define-fun buf0_length () (_ BitVec 256) (_ bv32 256))
(define-fun buf1() Buf (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000)))

(define-fun buf1_length () (_ BitVec 256) (_ bv32 256))


; keccak assumptions
(assert (or (and (= (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000)) (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000))) (= (_ bv32 256) (_ bv32 256))) (not (= (keccak (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000))) (keccak (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000)))))))
(assert (bvugt (keccak (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000))) (_ bv256 256)))
(assert (bvugt (keccak (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000))) (_ bv256 256)))
(assert (=> (not (= (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000)) (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000)))) (and (bvuge (bvsub (keccak (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000))) (keccak (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000)))) (_ bv256 256)) (bvuge (bvsub (keccak (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000))) (keccak (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000)))) (_ bv256 256)))))
(assert (=> (not (= (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000)) (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000)))) (and (bvuge (bvsub (keccak (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000))) (keccak (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000)))) (_ bv256 256)) (bvuge (bvsub (keccak (writeWord (_ bv0 256) arg1 ((as const Buf) #b00000000))) (keccak (writeWord (_ bv0 256) arg2 ((as const Buf) #b00000000)))) (_ bv256 256)))))
(assert true)
(assert true)
; keccak computations
; read assumptions
...
(assert (not (= (keccak buf0) (keccak buf1))))
