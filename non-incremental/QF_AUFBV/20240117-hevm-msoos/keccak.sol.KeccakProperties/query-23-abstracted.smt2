...
; variables
(declare-const arg13 (_ BitVec 256))
(declare-const arg23 (_ BitVec 256))
(declare-const arg12 (_ BitVec 256))
(declare-const arg22 (_ BitVec 256))
(declare-const arg11 (_ BitVec 256))
(declare-const arg21 (_ BitVec 256))
(declare-const arg10 (_ BitVec 256))
(declare-const arg20 (_ BitVec 256))
...
(assert (= arg11 arg21))
(assert (= arg10 arg20))
(assert (not (= (ite (bvslt (_ bv163 256) (max (_ bv260 256) txdata_length)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))))
(assert (not (= (ite (bvslt (_ bv35 256) (max (_ bv260 256) txdata_length)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))))
(assert (not (= (ite (bvslt (_ bv163 256) (max (_ bv260 256) txdata_length)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))))
