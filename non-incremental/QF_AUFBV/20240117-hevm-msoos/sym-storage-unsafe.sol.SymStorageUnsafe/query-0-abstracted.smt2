...
;        (Var "arg1")
;      storage:
;        (AbstractStore (SymAddr "entrypoint") Just 0x2)
;    )
;    (SLoad
;      slot:
;        (Var "arg2")
...
(declare-const baseStore_symaddr_entrypoint_0x2 Storage)
...
(assert (not (= (select baseStore_symaddr_entrypoint_0x2 arg1) (select baseStore_symaddr_entrypoint_0x2 arg2))))
(assert (bvult arg1 (select baseStore_symaddr_entrypoint (_ bv2 256))))
(assert (bvult arg2 (select baseStore_symaddr_entrypoint (_ bv2 256))))
