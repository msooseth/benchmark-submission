...
(assert (not (= (ite (= arg2 (_ bv0 256)) (_ bv0 256) (bvsdiv arg1 arg2)) (ite (= arg1 (_ bv0 256)) (_ bv0 256) (bvsdiv arg2 arg1)))))
(assert (= (bvand (ite (= (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639935 256) arg2) (_ bv1 256) (_ bv0 256)) (ite (= (_ bv57896044618658097711785492504343953926634992332820282019728792003956564819968 256) arg1) (_ bv1 256) (_ bv0 256))) (_ bv0 256)))
(assert (not (= arg2 (_ bv0 256))))
(assert (= (bvand (ite (= (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639935 256) arg1) (_ bv1 256) (_ bv0 256)) (ite (= (_ bv57896044618658097711785492504343953926634992332820282019728792003956564819968 256) arg2) (_ bv1 256) (_ bv0 256))) (_ bv0 256)))
(assert (not (= arg1 (_ bv0 256))))
(assert (bvult (_ bv0 256) arg2))
(assert (= (ite (= arg1 (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
