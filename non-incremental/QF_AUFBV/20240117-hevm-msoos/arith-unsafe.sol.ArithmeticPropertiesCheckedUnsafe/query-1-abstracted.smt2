...
(assert (not (= (bvsub arg1 (bvsub arg2 arg3)) (bvsub (bvsub arg1 arg2) arg3))))
(assert (= (ite (bvult arg1 (bvsub arg1 (bvsub arg2 arg3))) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (bvult arg2 (bvsub arg2 arg3)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (bvult (bvsub arg1 arg2) (bvsub (bvsub arg1 arg2) arg3)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (bvult arg1 (bvsub arg1 arg2)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (bvult arg1 (bvsub arg1 (bvsub arg2 arg3))) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (bvult (bvsub arg1 arg2) (bvsub (bvsub arg1 arg2) arg3)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
