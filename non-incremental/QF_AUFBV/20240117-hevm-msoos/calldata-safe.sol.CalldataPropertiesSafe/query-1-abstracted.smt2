...
(define-fun buf2() Buf (store buf1 (_ bv3 256) (_ bv39 8)))

(define-fun buf2_length () (_ BitVec 256) (max (_ bv68 256) txdata_length))
(define-fun buf3() Buf (store buf2 (_ bv2 256) (_ bv192 8)))

(define-fun buf3_length () (_ BitVec 256) (max (_ bv68 256) txdata_length))
(define-fun buf4() Buf (store buf3 (_ bv1 256) (_ bv234 8)))

(define-fun buf4_length () (_ BitVec 256) (max (_ bv68 256) txdata_length))
(define-fun buf5() Buf (store buf4 (_ bv0 256) (_ bv232 8)))
...
(assert (= (ite (= (readWord arg1 buf5) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (bvult (max (_ bv68 256) txdata_length) arg1))
(assert (bvult txdata_length (_ bv18446744073709551616 256)))
