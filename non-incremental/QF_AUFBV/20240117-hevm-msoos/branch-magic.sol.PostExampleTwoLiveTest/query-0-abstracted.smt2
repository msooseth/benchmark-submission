...
(assert (not (= (_ bv6912213124124532 256) arg2)))
(assert (not (= (bvand (_ bv255 256) (ite (= (ite (= (ite (= (ite (= arg1 (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256))) (_ bv0 256))))
