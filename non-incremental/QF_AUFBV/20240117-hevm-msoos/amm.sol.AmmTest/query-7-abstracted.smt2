...
; variables
(declare-const arg5 (_ BitVec 256))
...
(assert (= (ite (bvult (bvadd arg5 arg3) arg3) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and true (= (ite (bvult arg3 arg4) (_ bv1 256) (_ bv0 256)) (_ bv0 256))) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) (bvult (_ bv0 256) arg4)) (= (ite (= (ite (bvult (_ bv0 256) arg3) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) (not (= arg1 (_ bv0 256)))) (not (= arg1 (_ bv0 256)))) (not (= (concat (_ bv0 96) symaddr_arg2 ) (_ bv44203 256)))) true) (= arg1 (ite (= (ite (= arg1 (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)))) true) true) true) true) true) true) true) true) true) (and true (bvult txdata_length (_ bv18446744073709551616 256)))) true) true) true) (or (= arg1 (_ bv1 256)) (= arg1 (_ bv0 256)))))
