...
(define-fun buf0() Buf (writeWord (_ bv36 256) arg2 txdata))

(define-fun buf0_length () (_ BitVec 256) (max (_ bv68 256) txdata_length))
(define-fun buf1() Buf (writeWord (_ bv4 256) arg1 buf0))

(define-fun buf1_length () (_ BitVec 256) (max (_ bv68 256) txdata_length))
(define-fun buf2() Buf (store buf1 (_ bv3 256) (_ bv207 8)))

(define-fun buf2_length () (_ BitVec 256) (max (_ bv68 256) txdata_length))
(define-fun buf3() Buf (store buf2 (_ bv2 256) (_ bv55 8)))

(define-fun buf3_length () (_ BitVec 256) (max (_ bv68 256) txdata_length))
(define-fun buf4() Buf (store buf3 (_ bv1 256) (_ bv101 8)))

(define-fun buf4_length () (_ BitVec 256) (max (_ bv68 256) txdata_length))
(define-fun buf5() Buf (store buf4 (_ bv0 256) (_ bv33 8)))

(define-fun buf5_length () (_ BitVec 256) (max (_ bv68 256) txdata_length))


; keccak assumptions
; keccak computations
; read assumptions
(assert (=> (bvuge arg1 buf5_length) (= (readWord arg1 buf5) (_ bv0 256))))

(assert (bvult txdata_length (_ bv18446744073709551616 256)))
(assert (not (= arg1 (readWord arg1 buf5))))
(assert (= (ite (bvult (max (_ bv68 256) txdata_length) (bvadd (_ bv32 256) arg1)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (bvult (bvadd (_ bv32 256) arg1) (_ bv32 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
