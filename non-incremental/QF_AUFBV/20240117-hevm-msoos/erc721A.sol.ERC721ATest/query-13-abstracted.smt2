...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and true (= (select baseStore_symaddr_entrypoint_0x4 (bvadd (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639935 256) arg4)) (_ bv0 256))) (bvult arg4 (select baseStore_symaddr_entrypoint (_ bv0 256)))) (= (_ bv0 256) (select baseStore_symaddr_entrypoint_0x4 arg4))) (= (_ bv0 256) (bvand (_ bv26959946667150639794667015087019630673637144422540572481103610249216 256) (select baseStore_symaddr_entrypoint_0x4 (bvadd (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639935 256) arg4))))) (= (ite (= (select baseStore_symaddr_entrypoint_0x4 (bvadd (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639935 256) arg4)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))) (bvult arg4 (select baseStore_symaddr_entrypoint (_ bv0 256)))) (= (_ bv0 256) (select baseStore_symaddr_entrypoint_0x4 arg4))) (not (= arg4 arg3))) (= (bvand (_ bv53919893334301279589334030174039261347274288845081144962207220498432 256) (select baseStore_symaddr_entrypoint_0x4 arg3)) (_ bv0 256))) (= (bvand (_ bv53919893334301279589334030174039261347274288845081144962207220498432 256) (select baseStore_symaddr_entrypoint_0x4 arg3)) (_ bv0 256))) (= (bvand (_ bv53919893334301279589334030174039261347274288845081144962207220498432 256) (select baseStore_symaddr_entrypoint_0x4 arg3)) (_ bv0 256))) (= (_ bv0 256) (bvand (_ bv26959946667150639794667015087019630673637144422540572481103610249216 256) (select baseStore_symaddr_entrypoint_0x4 arg3)))) (not (= (_ bv0 256) (select baseStore_symaddr_entrypoint_0x4 arg3)))) (= (select baseStore_symaddr_entrypoint_0x4 arg3) (_ bv0 256))) (= (select baseStore_symaddr_entrypoint_0x4 arg3) (_ bv0 256))) (bvult (_ bv0 256) (select baseStore_symaddr_entrypoint_0x4 arg3))) (bvult (_ bv0 256) (select baseStore_symaddr_entrypoint_0x4 arg3))) (= (ite (bvult (_ bv79228162514264337593543950335 256) (select baseStore_symaddr_entrypoint (_ bv0 256))) (_ bv1 256) (_ bv0 256)) (_ bv0 256))) true) true) true) (= txvalue (_ bv0 256))) true) true) true) true) true) true) (and true (bvult txdata_length (_ bv18446744073709551616 256)))) true) true))
