...
(assert (not (bvult (_ bv0 256) (ite (= (bvand (_ bv26959946667150639794667015087019630673637144422540572481103610249216 256) (bvor (concat (_ bv0 96) symaddr_arg1 ) (bvor (bvshl (ite (= (_ bv1 256) arg2) (_ bv1 256) (_ bv0 256)) (_ bv225 256)) (bvshl timestamp (_ bv160 256))))) (_ bv0 256)) (_ bv1 256) (_ bv0 256)))))
