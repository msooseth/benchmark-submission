...
(assert (= (bvand (_ bv1461501637330902918203684832716283019655932542975 256) (bvor (concat (_ bv0 96) symaddr_arg1 ) (bvshl (ite (= (_ bv1 256) arg2) (_ bv1 256) (_ bv0 256)) (_ bv225 256)))) (concat (_ bv0 96) symaddr_arg1 )))
