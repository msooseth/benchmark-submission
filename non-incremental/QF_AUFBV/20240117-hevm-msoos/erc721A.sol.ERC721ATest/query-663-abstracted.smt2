...
(assert (= (select baseStore_symaddr_entrypoint_0x4 (bvadd (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639934 256) (select baseStore_symaddr_entrypoint (_ bv0 256)))) (_ bv0 256)))
