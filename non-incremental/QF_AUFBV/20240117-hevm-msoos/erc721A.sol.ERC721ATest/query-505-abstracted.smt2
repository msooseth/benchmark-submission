...
(assert (bvult (_ bv0 256) (ite (= (bvand (_ bv26959946667150639794667015087019630673637144422540572481103610249216 256) (select baseStore_symaddr_entrypoint_0x4 (bvadd (_ bv1 256) (select baseStore_symaddr_entrypoint (_ bv0 256))))) (_ bv0 256)) (_ bv1 256) (_ bv0 256))))
