...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and true (not (= (_ bv8 256) arg2))) (not (= (_ bv7 256) arg2))) (not (= (_ bv6 256) arg2))) (not (= (_ bv5 256) arg2))) (not (= (_ bv4 256) arg2))) (not (= (_ bv3 256) arg2))) (not (= (_ bv2 256) arg2))) (not (= (_ bv1 256) arg2))) (not (= (_ bv0 256) (concat (_ bv0 96) symaddr_arg1 )))) (not (= (_ bv0 256) arg2))) (= (ite (bvult (_ bv0 256) arg3) (_ bv1 256) (_ bv0 256)) (_ bv0 256))) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) true) (and true (bvult txdata_length (_ bv18446744073709551616 256)))) true) true))
