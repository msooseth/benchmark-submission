...
(assert (not (= arg1 (ite (= (_ bv2 256) (_ bv0 256)) (_ bv0 256) (bvudiv (bvmul (_ bv2 256) arg1) (_ bv2 256))))))
(assert (= arg1 (ite (= (_ bv2 256) (_ bv0 256)) (_ bv0 256) (bvudiv (bvmul (_ bv2 256) arg1) (_ bv2 256)))))
(assert (= (ite (bvult (bvadd (_ bv1 256) arg1) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= (ite (bvult (bvadd (_ bv1 256) arg1) (_ bv1 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (= arg1 (ite (= (_ bv2 256) (_ bv0 256)) (_ bv0 256) (bvudiv (bvmul (_ bv2 256) arg1) (_ bv2 256)))))
