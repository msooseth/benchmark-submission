...
(assert (bvult (_ bv0 256) (bvand (_ bv255 256) arg1)))
(assert (bvult (_ bv0 256) (bvand (_ bv65280 256) arg1)))
(assert (bvult (_ bv0 256) (bvand (_ bv16711680 256) arg1)))
(assert (bvult (_ bv0 256) (bvand (_ bv4278190080 256) arg1)))
(assert (bvult (_ bv0 256) (bvand (_ bv1095216660480 256) arg1)))
(assert (bvult (_ bv0 256) (bvand (_ bv280375465082880 256) arg1)))
(assert (bvult (_ bv0 256) (bvand (_ bv71776119061217280 256) arg1)))
(assert (bvult (_ bv0 256) (bvand (_ bv18374686479671623680 256) arg1)))
(assert (bvult (_ bv0 256) (bvand (_ bv4703919738795935662080 256) arg1)))
