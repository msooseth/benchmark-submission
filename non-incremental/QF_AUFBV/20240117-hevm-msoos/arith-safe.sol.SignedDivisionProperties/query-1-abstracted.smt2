...
(assert (= (ite (= (ite (bvslt (_ bv0 256) (ite (= arg2 (_ bv0 256)) (_ bv0 256) (bvsdiv arg1 arg2))) (_ bv1 256) (_ bv0 256)) (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
(assert (not (= (ite (bvslt arg2 (_ bv0 256)) (_ bv1 256) (_ bv0 256)) (_ bv0 256))))
