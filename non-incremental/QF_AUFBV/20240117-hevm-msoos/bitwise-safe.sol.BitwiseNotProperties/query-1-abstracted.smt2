...
(assert (not (= (_ bv115792089237316195423570985008687907853269984665640564039457584007913129639935 256) (bvadd (bvnot arg1) arg1))))
(assert (= (ite (bvult (bvadd (bvnot arg1) arg1) arg1) (_ bv1 256) (_ bv0 256)) (_ bv0 256)))
